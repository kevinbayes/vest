...
public class UriComponent {
     ...
     *            the URI.
     * @param decode
     *            true if the query parameters of the query component should be in decoded form.
     ...
     * @param decode
     *            true of the query parameters of the query component should be in decoded form.
     * @return the multivalued map of query parameters.
     */
        ...
        try {
            ...
            if (equals > 0) {
                params.add(
                        ...
                        (decode) ? URLDecoder.decode(param.substring(equals + 1), "UTF-8") : param
                                .substring(equals + 1));
            } else if (equals == 0) {
     ...
     * 
     * @param u
     *            the URI. If the path component is an absolute path component then the leading '/' is ignored and is
     *            not considered a delimiator of a path segment.
     * @param decode
     *            true if the path segments of the path component should be in decoded form.
    ...
    public static MultivaluedMap<String, String> decodeMatrix(String pathSegment, boolean decode) {
        MultivaluedMap<String, String> matrixMap = new MultivaluedHashMap();
