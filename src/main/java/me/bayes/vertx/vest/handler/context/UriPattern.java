...
/**
 * A URI pattern for matching a URI against a regular expression and returning capturing group values for any capturing
...
public class UriPattern {
	 ...
	 * Match a URI against the pattern.
	 * <p>
	 * If the URI matches against the pattern then the capturing group values (if any) will be added to a list passed in
	 * as parameter.
	 * 
	 * @param uri
	 *            the uri to match against the template.
	 ...
	 *            added in the same order as the pattern's capturing groups. The list is cleared before values are
	 *            added.
	 ...
	 * Match a URI against the pattern.
	 * <p>
	 * If the URI matches against the pattern then the capturing group values (if any) will be added to a map passed in
	 * as parameter.
	 * 
	 * @param uri
	 *            the uri to match against the template.
	 * @param groupNames
	 *            the list names associated with a pattern's capturing groups. The names MUST be in the same order as
	 *            the pattern's capturing groups and the size MUST be equal to or less than the number of capturing
	 *            groups.
	 * @param groupValues
	 *            the map to add the values of a pattern's capturing groups if matching is successful. A values is put
	 *            into the map using the group name associated with the capturing group. The map is cleared before
	 *            values are added.
	 * @return true if the URI matches the pattern, otherwise false.
	 * @throws IllegalArgumentException
	 *             if the uri or capturingGroupValues is null.
