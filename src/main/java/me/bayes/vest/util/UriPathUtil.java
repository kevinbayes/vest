...
public final class UriPathUtil {
	...
	/**
	 * Retrieve the context from the provided {@link javax.ws.rs.core.Application}'s {@link javax.ws.rs.ApplicationPath}.
	 *
	 * @param application with a {@link javax.ws.rs.ApplicationPath} annotation.
